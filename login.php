...
if(isset($_POST['username']))
{
  if($check)
  {
    ...
    foreach ($connection->query($sql) as $row) {
      ...
      {
          header("Location: http://127.0.0.1/FoodBank2/bank.php");
      }elseif($_SESSION['user_type'] == 2)
      {
          header("Location: http://127.0.0.1/FoodBank2/shop.php");
      }else
      {
          header("Location: http://127.0.0.1/FoodBank2/admin.php");
      }
...
<body>
<div class="container">
<form class="form-horizontal" method="post" action="http://127.0.0.1/FoodBank2/login.php">
  <fieldset>
