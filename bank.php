...
<body>
<div class="container">
<form class="form-horizontal" method="post" action="http://127.0.0.1/FoodBank2/bank.php">
  <fieldset>
...
<table class="table table-striped table-hover table-bordered table-condensed">
  ...
  <tbody>
    ...
    if(isset($_POST['search_name']))
    {
      ...
      $sql = "SELECT products.name, products.quantity, shops.address, shops.mobile,shops.name as shop_name FROM products inner join shops on shops.id=products.shop_id inner join foodbanks on foodbanks.user_id=shops.id where products.name='$product_name' and foodbanks.user_id= '$user_id'";
      // echo $sql;
