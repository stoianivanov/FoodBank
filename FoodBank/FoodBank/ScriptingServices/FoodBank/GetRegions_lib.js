...
exports.createRegions = function() {
    var input = request.readInputText();
    var requestBody = JSON.parse(input);
    var connection = datasource.getConnection();
    try {
        var sql = "INSERT INTO REGIONS (";
        sql += "ID";
        sql += ",";
        sql += "NAME";
        sql += ") VALUES ("; 
        ...
        var i = 0;
        var id = datasource.getSequence('REGIONS_ID').next();
...
exports.readRegionsEntity = function(id) {
    var connection = datasource.getConnection();
    try {
        var result;
        var sql = "SELECT * FROM REGIONS WHERE " + exports.pkToSQL();
        var statement = connection.prepareStatement(sql);
...
exports.readRegionsList = function(limit, offset, sort, desc) {
    var connection = datasource.getConnection();
    try {
        var result = [];
        var sql = "SELECT ";
...
// update entity by id
exports.updateRegions = function() {
    var input = request.readInputText();
    var responseBody = JSON.parse(input);
    var connection = datasource.getConnection();
    try {
        var sql = "UPDATE REGIONS SET ";
        sql += "NAME = ?";
        sql += " WHERE ID = ?";
        var statement = connection.prepareStatement(sql);
        var i = 0;
...
// delete entity
exports.deleteRegions = function(id) {
    var connection = datasource.getConnection();
    try {
    	var sql = "DELETE FROM REGIONS WHERE " + exports.pkToSQL();
        var statement = connection.prepareStatement(sql);
...
exports.countRegions = function() {
    var count = 0;
    var connection = datasource.getConnection();
    try {
    	var sql = 'SELECT COUNT(*) FROM REGIONS';
        var statement = connection.prepareStatement(sql);
...
exports.metadataRegions = function() {
	var entityMetadata = {
		name: 'regions',
		type: 'object',
		properties: []
